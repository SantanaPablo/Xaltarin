...
class VpnTimerService : Service() {
    ...
    private val vpnConnection = object : ServiceConnection {
        ...
        override fun onServiceConnected(
            ...
            vpnService =
                IOpenVPNServiceInternal.Stub.asInterface(service)
    ...
    override fun onStartCommand(
        ...
        startForeground(
            NOTIF_ID,
            crearNotificacion(
                "VPN activa - desconectando en ${seconds}s"
            )
        )
    ...
    private fun iniciarConteo(
        ...
        serviceScope.launch {
            ...
            android.util.Log.d(
                "SALTARIN_VPN",
                "Tiempo cumplido, desconectando VPN"
            )

            try {

                val intent = Intent(
                    this@VpnTimerService,
                    OpenVPNService::class.java
                )

                intent.action =
                    OpenVPNService.START_SERVICE
                ...
                android.util.Log.e(
                    "SALTARIN_VPN",
                    "Error conectando al servicio VPN",
                    e
                )
